...
//文字数チェック
stringMaxSizeCheck($_SESSION['errors'], $user_name, "ユーザー名は255文字以内です。");
stringMaxSizeCheck($_SESSION['errors'], $user_email, "メールアドレスは255文字以内です。");
stringMaxSizeCheck($_SESSION['errors'], $user_password, "パスワードは255文字以内です。");
stringMinSizeCheck($_SESSION['errors'], $user_password, "パスワードは8文字以上です。");
...
if(!$_SESSION['errors']){
    ...
    //ユーザー名・パスワード半角英数チェック
    halfAlphanumericCheck($_SESSION['errors'], $user_name, "ユーザ名は半角英数字で入力してください");
